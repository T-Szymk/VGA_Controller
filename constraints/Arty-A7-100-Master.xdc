...
set_false_path -from [get_ports {sw_in[0]}]
set_false_path -from [get_ports {sw_in[1]}]
set_false_path -from [get_ports {sw_in[2]}]
...
set_property -dict {PACKAGE_PIN C10 IOSTANDARD LVCMOS33} [get_ports {sw_in[2]}]
...
## Buttons
#set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports { rst_n }]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
set_property MARK_DEBUG false [get_nets {r_colr_out_OBUF[0]}]
set_property MARK_DEBUG false [get_nets {r_colr_out_OBUF[1]}]
set_property MARK_DEBUG false [get_nets {r_colr_out_OBUF[2]}]
set_property MARK_DEBUG false [get_nets {r_colr_out_OBUF[3]}]
set_property MARK_DEBUG false [get_nets h_sync_out_OBUF]
set_property MARK_DEBUG false [get_nets v_sync_out_OBUF]
